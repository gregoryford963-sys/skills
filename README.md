...
| [clarity-patterns](./clarity-patterns/) | `clarity-patterns/clarity-patterns.ts` | Clarity smart contract pattern library — query, search, and retrieve bundled best-practice code patterns, testing workflows, and registry contract templates. |
